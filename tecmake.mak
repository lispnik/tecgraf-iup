...
ifdef LINK_WEBKIT
  ...
  ifneq ($(findstring Linux2, $(TEC_UNAME)), )
    LIBS += webkit-1.0
  endif
endif
...
ifdef USE_OBJDIRS
  OBJ = $(SRC)
  # OBJDIRS: object directories with relative paths
...
.PHONY: directories
directories: $(OBJDIR) $(OBJDIRS) $(TARGETDIR) $(EXTRADIR) $(LOHDIR) $(LHDIR) $(DEPENDDIR)

$(OBJDIRS) $(OBJDIR) $(TARGETDIR):
